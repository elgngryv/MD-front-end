...
import CustomDropdown from "../../components/CustomDropdown"; // Bu komponenti olduğu kimi saxlayırıq
import DownloadIcon from "../../assets/icons/Download";
import { useNavigate } from "react-router-dom";
import useWarehouseDeletionStore from "../../../stores/warehouseDeletionStore"; // Yeni: Deletion Store importu
    ...
    return (
        <div className="flex flex-col border border-gray-200 rounded-lg bg-white p-1">
            ...
            <SimpleList 
                ...
                enableEdit={true} 
                enableView={true} 
                handleView={(id) => { navigate("/stock/delete/info/" + id) }} 
                handleEdit={(id) => { navigate("/stock/delete/" + id + "/edit") }} // Redaktə səhifəsinə yönləndirmə
